...
def generate_mod_LR_bic():
    ...
    savedir = "/opt/data/us_data/us_test/us_images_sig3_size21/"
    ...
    for i in range(num_files):
        ...
        for sig in np.arange(3, 4, 1):
            prepro = util.SRMDPreprocess(scale=4, batch_size=1, sigma=[sig], generate_kernel=False)
