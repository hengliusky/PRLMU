...
img_folder = "/opt/data/us_data/us_test/us_images_sig2_size21/LRblur/x4/*"
# lmdb_save_path = '/data/DIV2K/DIV2K_train_LR_sub.lmdb'
lmdb_save_path = "/opt/data/us_data/us_test/us_images_sig2_size21/LRblur.lmdb"
meta_info = {"name": "rolf48"}

mode = (
    1  # 1 for reading all the images to memory and then writing to lmdb (more memory);
)
